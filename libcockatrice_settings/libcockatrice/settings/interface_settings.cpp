...
bool InterfaceSettings::getShowSubtypeSelectionTally() const
{
    return getValue("showsubtypeselectiontally", QString(), QString(), true).toBool();
}
...
void InterfaceSettings::setShowSubtypeSelectionTally(bool _showSubtypeSelectionTally)
{
    setValue(_showSubtypeSelectionTally, "showsubtypeselectiontally");
}
