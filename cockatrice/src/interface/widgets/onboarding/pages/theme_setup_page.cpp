...
// Adjust these three to wherever they actually live relative to this file.
...
ThemeSetupPage::ThemeSetupPage(QWidget *parent) : FirstRunWizardPage(parent)
{
    ...
    connect(themeCombo, qOverload<int>(&QComboBox::currentIndexChanged), this, &ThemeSetupPage::onThemeChanged);
    connect(schemeCombo, qOverload<int>(&QComboBox::currentIndexChanged), this, &ThemeSetupPage::onSchemeChanged);
    connect(quickSetupPanel, &QuickSetupPanel::generateRequested, this, &ThemeSetupPage::onGenerateFromAccent);
