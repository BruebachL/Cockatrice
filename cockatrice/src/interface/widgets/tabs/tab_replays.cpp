...
QGroupBox *TabReplays::createLeftLayout()
{
    ...
    aOpenLocalReplay->setIcon(themePixmap("icons/view"));
    ...
    aDeleteLocalReplay->setIcon(themePixmap("icons/remove_row"));
...
QGroupBox *TabReplays::createRightLayout()
{
    ...
    aOpenRemoteReplay->setIcon(themePixmap("icons/view"));
