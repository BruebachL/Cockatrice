...
UserInterfaceSettingsPage::UserInterfaceSettingsPage()
{
    ...
    showSubtypeSelectionTallyCheckBox.setChecked(SettingsCache::instance().interface().getShowSubtypeSelectionTally());
    connect(&showSubtypeSelectionTallyCheckBox, &QCheckBox::QT_STATE_CHANGED, &SettingsCache::instance().interface(),
            &InterfaceSettings::setShowSubtypeSelectionTally);
