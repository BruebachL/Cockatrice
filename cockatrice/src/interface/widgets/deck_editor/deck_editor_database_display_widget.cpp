    ...
    : QWidget(parent)
{
    ...
    auto help = searchEdit->addAction(themePixmap("icons/info"), QLineEdit::TrailingPosition);
    ...
    aAddCard->setIcon(themePixmap("icons/arrow_right_green"));
    ...
    aAddCardToSideboard->setIcon(themePixmap("icons/arrow_right_blue"));
